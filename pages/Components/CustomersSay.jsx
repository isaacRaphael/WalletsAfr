  ...
  return (
    ...
    <div className='flex w-full h-[1300px] bg-black py-28'>
        ...
        <div className='w-full'>
            <h1 className='text-[#ccc] text-[44px] o-text'>What our customers are saying…</h1>
            <p className='text-[#ccc] text-[24px] my-2 o-text'>We serve thousands of customers and this is what people are saying about us</p>
        </div>
        <div className='w-full flex items-center justify-center'>
            <div className='text-center text-[40px] text-[#ccc] py-[12rem] o-text max-w-[1240px] relative'>The Wallets payroll is seamless, the cards & sub wallets allow us to be flexible with payments and 
        ...
        <div className='w-full py-10'>
            <div className='flex gap-6'>
                ...
                <div className=' flex flex-col justify-around'>
                    <h1 className='o-text text-3xl text-white'>Co-founder, Releaf (YC S17)</h1>
                    <p className='text-[#ccc] text-xl'>Co-founder, Releaf (YC S17)</p>
                </div>
            </div>
        </div>
